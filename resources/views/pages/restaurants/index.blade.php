...
@section('content')
 <button class="btn btn-primary"><a href="/restaurants/create">Thêm món ăn</a></button>
    <div class="row justify-content-center gap-3 list-product" >
        @foreach ($restaurantList as $restaurant)
            <div class="card col-4" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <p class="card-text col-6">{{$restaurant->price}}</p>
                    </div>
